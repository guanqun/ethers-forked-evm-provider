use crate::akula::delta::Delta;
use crate::akula::interface::State;
use crate::akula::types::{Account, CommittedValue, Incarnation, Log, Object, Storage};
...
impl<S: State> IntraBlockState<S> {
